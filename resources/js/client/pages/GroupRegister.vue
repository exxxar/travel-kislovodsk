    ...
    <main class="container">
        <div class="main row d-flex justify-content-center">
            <div class="row col-11 col-md-10 col-lg-8 mx-0 px-0">
                ...
                <p class="col-12 px-0 mb-5 bold font-size-09">
                ...
                <div class="col-12 row px-0 mx-0 mb-5">
                    ...
                    <div class="col row px-0 mx-0 ms-2">
                        ...
                        <span class="col-12 px-0 opacity-70 bold font-size-09">application deadline 10 working days
                ...
                <div class="col-12 row px-0 mx-0 mb-5">
                    ...
                    <div class="col row px-0 mx-0 ms-2">
                        <p class="px-0">
                            ...
                            <span class="px-0 bold font-size-09">В случае отсутствия информации по какому-либо из
                                пунктов, просим </span>
                ...
                <div class="col-12 row px-0 mx-0 mb-5 align-items-center">
                    <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                        ...
                        <div class="col px-0 ms-2 d-flex flex-column">
                            ...
                            <span class="bold font-size-09 opacity-70">Registration date</span>
                        </div>
                    </div>
                    <input type="date" name="group-registration-date" placeholder="15 сентября 2022"
                           v-model="groupForm.registration_date"
                           class="bold col-12 col-md-3 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                </div>
                <div class="col-12 row px-0 mx-0 mb-5">
                    <div class="col-12 row px-0 mx-0">
                        ...
                        <div class="col px-0 ms-2 d-flex flex-column">
                            ...
                            <span class="bold font-size-09 opacity-70">Tourist agency information (for tourist event
                    ...
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            ...
                            <span class="bold opacity-70">Name</span>
                        </div>
                        <input type="text" name="group-agency-name"
                               v-model="groupForm.company.title"
                               class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Адрес</span>
                            <span class="bold opacity-70">Address</span>
                        </div>
                        <input type="text" name="group-agency-address"
                               v-model="groupForm.company.address"
                               class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Контактный телефон</span>
                            <span class="bold opacity-70">Phone number</span>
                        </div>
                        <input type="text" name="group-agency-phone"
                               v-mask="'+7(###)###-##-##'"
                               v-model="groupForm.company.phone"
                               class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                </div>
                <div class="col-12 row px-0 mx-0 mb-5">
                    <div class="col-12 row px-0 mx-0">
                        ...
                        <div class="col px-0 ms-2 d-flex flex-column">
                            ...
                            <span class="bold font-size-09 opacity-70">Tour group leader information / individual
                                tourist</span>
                        </div>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            ...
                            <span class="bold opacity-70">Last name</span>
                        </div>
                        <input type="text" name="group-leader-lastname"
                               v-model="groupForm.guide.last_name"
                               class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Имя</span>
                            <span class="bold opacity-70">First name</span>
                        </div>
                        <input type="text" name="group-leader-firstname"
                               v-model="groupForm.guide.first_name"
                               class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Отчество</span>
                            <span class="bold opacity-70">-</span>
                        </div>
                        <input type="text" name="group-leader-patronymic"
                               v-model="groupForm.guide.second_name"
                               class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 " required>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Год рождения</span>
                            <span class="bold opacity-70">Date of birth</span>
                        </div>
                        <input type="date" name="group-leader-birthdate"
                               v-model="groupForm.guide.date_of_birth"
                               class="bold col-12 col-md-2 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Адрес проживания</span>
                            <span class="bold opacity-70">Home address</span>
                        </div>
                        <input type="text" name="group-leader-home-address"
                               v-model="groupForm.guide.home_address"
                               class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Домашний телефон</span>
                            <span class="bold opacity-70">Home phone</span>
                        </div>
                        <input type="text" name="group-leader-home-phone"
                               v-mask="'+7(###)###-##-##'"
                               v-model="groupForm.guide.home_phone"
                               class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Рабочий телефон</span>
                            <span class="bold opacity-70">Office phone</span>
                        </div>
                    ...
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Мобильный телефон</span>
                            <span class="bold opacity-70">Mobile phone</span>
                        </div>
                    ...
                    <div class="col-12 row mx-0 mt-3 px-0">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Сведения о близком родственнике или ином контактном лице (ФИО,
                                контактный телефон) - заполняет турист, совершающий одиночный маршрут</span>
                            <span class="bold opacity-70">information about relative or other contact
                ...
                <div class="col-12 row px-0 mx-0 mb-5">
                    <div class="col-12 row px-0 mx-0">
                        ...
                        <div class="col px-0 ms-2 d-flex flex-column">
                            ...
                            <span class="bold font-size-09 opacity-70">Tour group participants</span>
                        </div>
                    </div>
                        ...
                        <div class="col mx-0 px-0">
                            <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                                <div class="col-12 ps-0">
                                    ...
                                    <span class="bold opacity-70 ms-2">name</span>
                                </div>
                                <input type="text" name="group-participant-name"
                                       v-model="memberForm.full_name"
                                       class="bold col-12 px-2rem py-4 rounded border-0 ">
                            </div>
                            <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                                <div class="col-12 ps-0">
                                    <span class="bold ">дата рождения</span>
                                    <span class="bold opacity-70 ms-2">date of birth</span>
                                </div>
                                <input type="date" name="group-participant-birthdate"
                                       v-model="memberForm.date_of_birth"
                                       class="bold col-12 col-md-6 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                            </div>
                            <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                                <div class="col-12 ps-0">
                                    <span class="bold ">адрес места жительства</span>
                                    <span class="bold opacity-70 ms-2">home address</span>
                                </div>
                            ...
                            <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                                <div class="col-12 ps-0">
                                    <span class="bold ">контактный телефон</span>
                                    <span class="bold opacity-70 ms-2">phone number</span>
                                </div>
                                <input type="text" name="group-participant-phone"
                                       v-mask="'+7(###)###-##-##'"
                                       v-model="memberForm.phone_number"
                                       class="bold col-12 col-md-8 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                            </div>
                            <button
                        ...
                        <div class="col mx-0 mt-4 px-0 ps-md-4">
                            ...
                            >
                                <div class="col d-flex flex-column justify-content-md-between">
                                    ...
                                    <span class="bold">{{ item.date_of_birth || 'Не добавлено' }}</span>
                                    <span class="bold">{{ item.home_address || 'Не добавлено' }}</span>
                                    <span class="bold">{{ item.phone_number || 'Не добавлено' }}</span>
                                </div>
                                <button
                                    type="button"
                ...
                <div class="col-12 row px-0 mx-0 mb-5">
                    <div class="col-12 row px-0 mx-0">
                        ...
                        <div class="col px-0 ms-2 d-flex flex-column">
                            ...
                            <span class="bold font-size-09 opacity-70">Group size (inc. tour group leader)</span>
                        </div>
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Общее количество</span>
                            <span class="bold opacity-70">Total number</span>
                        </div>
                        <input type="number" name="group-number-total"
                               v-model="groupForm.group_info.members_count"
                               min="0" step="1"
                               class="bold col-3 col-md-2 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Из них дети (с указанием возраста)</span>
                            <span class="bold opacity-70">Number of children (age)</span>
                        </div>
                        <div class="col-9 col-md-7 mt-2  d-flex justify-content-between"
                            ...
                            <input type="number" name="group-number-children"
                                   ...
                                   class="bold col-3 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">

                            <input type="number" name="group-children-age"
                                   v-model="groupForm.group_info.children[index].count"
                                   class="bold col-8 px-2rem py-4 rounded border-0 ">
                    ...
                    <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                        <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Из них иностранные граждане (с указанием страны)</span>
                            <span class="bold opacity-70">Number of foriegn citizens (country)</span>
                        </div>
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 row px-0 mx-0">
                            ...
                            <div class="col px-0 ms-2 d-flex flex-column">
                                ...
                                <span class="bold font-size-09 opacity-70">Route information</span>
                            </div>
                        </div>
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Место начала маршрута</span>
                                <span class="bold opacity-70">Start point</span>
                            </div>
                            <input type="text" name="group-route-start"
                                   v-model="groupForm.route_info.start_point"
                                   class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                        </div>
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Место окончания маршрута</span>
                                <span class="bold opacity-70">Final destination</span>
                            </div>
                            <input type="text" name="group-route-end"
                                   v-model="groupForm.route_info.final_point"
                                   class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                        </div>
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Протяженность маршрута</span>
                                <span class="bold opacity-70">Route distance</span>
                            </div>
                            <input type="number" name="group-route-distance"
                                   v-model="groupForm.route_info.route_distance"
                                   class="bold col-12 col-md-4 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                        </div>
                        <div class="col-12 row mx-0 mt-3 px-0">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Сведения о субъектах РФ, по которым пролегает маршрут</span>
                                <span
                                    class="bold opacity-70">Areas of the Russian Federation on which the route runs</span>
                            </div>
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Предполагаемые места ночлега и отдыха</span>
                                <span class="bold opacity-70">Lodging points</span>
                            </div>
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Маршруты аварийных выходов (для маршрутов, имеющих категории
                                сложности)</span>
                                <span class="bold opacity-70">Emergency exit routes (for routes with category of
                                difficulty)</span>
                            </div>
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Наличие опасных участков на маршруте (речные пороги, водопады, ледники,
                                переходы по льду и иные участки)</span>
                                <span class="bold opacity-70">Dangerous route sections (river rapids, waterfalls, glaciers,
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                            <span class="bold ">Категория сложности, способ передвижения, применяемые средства
                                передвижения</span>
                                <span class="bold opacity-70">Category of difficulty, means of travel</span>
                            </div>
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5 align-items-center">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <div class="col px-0 ms-2 d-flex flex-column">
                                ...
                                <span class="bold font-size-09 opacity-70">Start date</span>
                            </div>
                        </div>
                        <input type="date" name="group-start-date"
                               v-model="groupForm.start_date"
                               class="bold col-12 col-md-3 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <span class="bold font-size-09">Дата возвращения с маршрута / Резервная дата возвращения с
                                маршрута</span>
                                <span class="bold font-size-09 opacity-70">Return date / reserve return date</span>
                            </div>
                        </div>
                        <input type="date" name="group-return-date"
                               v-model="groupForm.return_date"
                               class="bold col-12 col-md-3 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">
                    </div>
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <span class="bold font-size-09">Срок и способ информирования территориального органа МЧС
                                ...
                                <span class="bold font-size-09 opacity-70">Date and method of informing Ministry of
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        ...
                        <div  v-for="(item, index) in groupForm.date_and_method_communication_sessions">
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 row px-0 mx-0">
                            ...
                            <div class="col px-0 ms-2 d-flex flex-column">
                                ...
                                <span class="bold font-size-09 opacity-70">Communications means</span>
                            </div>
                        </div>
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold">Мобильный телефон (с указанием нескольких абонентов)</span>
                                <span class="bold opacity-70">Mobile phone of several participants</span>
                            </div>
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0 align-items-center">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Спутниковый телефон</span>
                                <span class="bold opacity-70">Satellite phone</span>
                            </div>
                            <input type="text" name="group-satellite-phone"
                                   ...
                                   v-mask="'+7(###)###-##-##'"
                                   class="bold col-12 col-md-4 px-2rem py-4 rounded border-0 ">

                            <button
                                @click="addSatellitePhone()"
                                type="button"
                                class="big-button bold bg-blue col-12 col-md-auto mt-3 px-5 rounded font-size-09">
                                Добавить
                                /
                        ...
                        <div class="col-12 row mx-0 mt-3 px-0">
                            <div class="col-12 col-md-3 ps-0 pe-4 d-flex flex-column">
                                <span class="bold ">Радиостанция (с указанием частот)</span>
                                <span class="bold opacity-70">Radio station (with frequency indication)</span>
                            </div>
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <span class="bold font-size-09">Наличие заряженных запасных элементов питания к средствам
                                ...
                                <span class="bold font-size-09 opacity-70">Charged batteries for communication means and
                                signal means</span>
                            </div>
                        </div>
                        <input type="text" name="group-batteries-and-signals"
                               v-for="(item, index) in groupForm.charge_batteries"
                               v-model="groupForm.charge_batteries[index]"
                               class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">

                        <button
                            @click="addChargesBattery()"
                            type="button"
                            class="big-button bold bg-blue col-12 col-md-auto mt-3 px-5 rounded font-size-09">
                            Добавить
                            /
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <div class="col px-0 ms-2 d-flex flex-column">
                                ...
                                <span class="bold font-size-09 opacity-70">First aid equipment</span>
                            </div>
                        </div>
                        <input type="text" name="group-first-aid"
                               v-for="(item, index) in groupForm.first_aid_equipments"
                               v-model="groupForm.first_aid_equipments[index]"
                               class="bold col-12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">

                        <button
                            @click="addFirstAidEquipments()"
                            type="button"
                            class="big-button bold bg-blue col-12 col-md-auto mt-3 px-5 rounded font-size-09">
                            Добавить
                            /
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <div class="col px-0 ms-2 d-flex flex-column">
                                ...
                                <span class="bold font-size-09 opacity-70">Medical professionals on the route</span>
                            </div>
                        </div>
                        <input type="text" name="group-first-aid"
                               v-for="(item, index) in groupForm.medical_professionals"
                               v-model="groupForm.medical_professionals[index]"
                               class="bold col-f12 col-md-9 mt-2 mt-md-0 px-2rem py-4 rounded border-0 ">

                        <button
                            @click="addMedicalProfessionals()"
                            type="button"
                            class="big-button bold bg-blue col-12 col-md-auto mt-3 px-5 rounded font-size-09">
                            Добавить
                            /
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <span class="bold font-size-09">Наличие страхового полиса на маршруте (название страхового
                                ...
                                <span class="bold font-size-09 opacity-70">Insurance (name of insurance agency, phone
                                number)</span>
                            </div>
                        </div>
                    ...
                    <div class="col-12 row px-0 mx-0 mb-5">
                        <div class="col-12 col-md-3 row ps-0 pe-4 mx-0">
                            ...
                            <span class="bold font-size-09">Дополнительная информация, которую желает сообщить
                                ...
                                <span class="bold font-size-09 opacity-70">Additional information</span>
                            </div>
                        </div>
                        <input type="text" name="group-insurance"
                               v-for="(item, index) in groupForm.additional_info"
                    ...
                    <div class="col-12 px-0 mx-0 mb-3">
                        <div class="dt-check">
                            ...
                            <label class="dt-check__label">
                                <slot name="label">
                                    <p class="fw-bold letter-spacing-1">все данные введены мною верно</p>
                                </slot>
                            </label>
                        </div>
                    </div>
                    <div class="col-12 row mx-0 px-0 align-items-center mb-3">
                        <div class="dt-check ps-0">
                            ...
                            <label class="dt-check__label">
                                <slot name="label">
                                    <p class="fw-bold letter-spacing-1">
                                        Я соглашаюсь с
                                        <a href="#" class="text-decoration-underline">Условиями использования сайта</a>
                                        и даю
                    ...
                    <div class="col-12 row mx-0 px-0 align-items-center mb-3">
                        <button
                            class="big-button bold bg-blue col-12 col-md-4 mt-5 mt-md-0 px-5 rounded font-size-09">
                            Отправить
                            заявку
                        </button>
                    </div>
