<template>
    <div class="dt-review__item d-flex">
        <div class="dt-review__avatar">
            <img v-if="item.user_avatar !== ''" v-lazy="'/img/avatars/2.jpg'" alt="">
        ...
        <div class="dt-review__header d-lg-none d-block">
            <div class="dt-header__user">
                <p class="dt-user__date-ago fw-thin text-muted">{{ item.date }}</p>
        ...
        <div class="dt-review__block flex-grow-1">
            ...
            <div v-if="item.photos.length !== 0" class="dt-form dt-review__photos">
                <div v-for="(photo, i) in item.photos" :key="i" class="dt-photos__item p-0">
                    <img v-lazy="'/img/travels/' + photo"/>
                </div>
            </div>
        </div>
    </div>
