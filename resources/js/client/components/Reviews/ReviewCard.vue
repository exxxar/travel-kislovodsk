    ...
    <div class="dt-review__item d-flex">
        ...
        <div class="dt-review__header d-lg-none d-block">
            <div class="dt-header__user">
                <p class="dt-user__date-ago fw-thin text-muted">{{ item.created_at }}</p>
        ...
        <div class="dt-review__block flex-grow-1">
            <div class="dt-review__header d-lg-block d-none">
                <div class="dt-header__user">
                    <p class="dt-user__date-ago fw-thin text-muted">{{ moment(item.created_at).format('YYYY-MM-DD H:m:s')  }}</p>
                    <p class="dt-user__name fw-semibold">{{ item.user_name }}</p>
                </div>
                <div class="dt-rating__star w-auto d-flex">
                    <img v-lazy="item.rating>=1?'/img/icons/star_blue.svg':'/img/icons/star_grey.svg'"  alt="">
                    <img v-lazy="item.rating>=2?'/img/icons/star_blue.svg':'/img/icons/star_grey.svg'"  alt="">
                    <img v-lazy="item.rating>=3?'/img/icons/star_blue.svg':'/img/icons/star_grey.svg'"  alt="">
                    <img v-lazy="item.rating>=4?'/img/icons/star_blue.svg':'/img/icons/star_grey.svg'"  alt="">
                    <img v-lazy="item.rating>=5?'/img/icons/star_blue.svg':'/img/icons/star_grey.svg'"  alt="">
                </div>
            </div>
