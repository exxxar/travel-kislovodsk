    ...
    <div class="dt-page__messages-content bg-white col-12 col-lg-8">
        ...
        <div class="splitted splitted-lg-none visible-lg col-12 col-lg position-relative
            ...
            <div class="messages-body p-4">
                ...
                <div class="messages-body__input d-flex rounded pe-2 mt-2rem bg-light align-items-center">
                    <input class="d-flex order-2 order-lg-1 flex-grow-1 px-3 px-lg-4 border-0 bg-light" type="text">
                    ...
                    <button class="order-3 big-icon rounded ms-3 dt-btn-blue">
