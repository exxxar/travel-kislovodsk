<template>
    <div id="add-object-tour" class="add-object-tour col ">
        <form v-on:submit.prevent="submitTourObject"
              v-if="isCompletelyLoaded" id="addObjectForm">
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="accordion-body">
                                    <div class="mb-4 row mx-0">
                                        ...
                                        <input type="text" v-model="tourObject.title" maxlength="255"
                                               name="add-obj-name" class="col-12 px-2rem py-4 rounded font-size-09" required>
                                    </div>
                                    <div class="mb-4 row mx-0">
                                        ...
                                        <div name="add-obj-photo" class="row mx-0 px-0 gap-2">
                                            ...
                                            <div class="add-additional-photo  mr-2" v-for="(item, index) in items">
                                                <img class="position-relative top-0 start-0 img rounded w-100 h-100"
                                                     v-if="item.imageUrl" v-lazy="item.imageUrl" alt="">
                                                <div
                                            ...
                                            <div v-if="tourObject.photos && tourObject.photos.length>0"
                                                 class="add-additional-photo  mr-2"
                                                 v-for="(item, index) in tourObject.photos">
                                                <img class="position-relative top-0 start-0 img rounded w-100 h-100"
                                                     v-lazy="item"
                                                     alt="">
                                                <div
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <button data-bs-toggle="modal"
                                                        data-bs-target="#map-select-object-coords"
...
export default {
    ...
    methods: {
        ...
        submitTourObject() {
            ...
            this.$store.dispatch("editAdminTourObject", {
