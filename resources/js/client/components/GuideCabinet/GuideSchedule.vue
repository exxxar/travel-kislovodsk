<template>
    <div id="calendar" class="col ">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="row">
                    <div class="col-12 col-md-6 mb-2">
                        <button type="button" @click="filterObject.filter_type =1"
                                v-bind:class="{'active':filterObject.filter_type===1}"
                                class="btn-schedule dt-btn-white rounded w-100 ms-0">
                            Сегодня
                        </button>
                    </div>
                    <div class="col-12 col-md-6 mb-2">
                        <button type="button" @click="filterObject.filter_type =2"
                                v-bind:class="{'active':filterObject.filter_type ===2 }"
                                class="dt-btn-white rounded w-100 ms-0 btn-schedule">
                            Ближайшие даты
                        </button>
                    </div>
                    <div class="col-12 col-md-12 mb-2">
                        <button type="button" @click="filterObject.filter_type =0"
                                v-bind:class="{'active':filterObject.filter_type ===0}"
                                class="dt-btn-white rounded w-100 ms-0 btn-schedule w-100">
                            Выбранная дата
                        </button>
                    </div>
                </div>
                ...
                <div v-if="schedule.length>0">
                    <p class="mt-2" style="color:gray; text-align: center;"><small>Событий всего -
                        {{ schedule.length }}</small></p>
                    <div class="mt-4" v-for="item in groupByDate">
                        ...
                        <div
                            ...
                            <div class="col-12 row mx-0 px-0 mt-2">
                                ...
                                <a :href="'/tour/'+date.tour.id" target="_blank"
                    ...
                    <button v-if="canLoadMore" @click="loadMoreSchedule"
            ...
            <div class="col-12 col-md-6 sticky-calendar">
                <tour-calendar-component v-on:select-date="updateDate" :inline="true"
                    :only-self-tour="true" :multiCalendars="false" />
