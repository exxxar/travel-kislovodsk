<template>
    <section id="personal-account" class="personal-account">
        <div class="container">
            <div class="dt-preheader__breadcrumbs personal-account-breadcrumbs">
                <nav style="--bs-breadcrumb-divider: '❯';" aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item text-nowrap">Главная</li>
                        <li class="breadcrumb-item text-nowrap">личный кабинет</li>
                    </ol>
                </nav>
            </div>
            <div class="personal-account__row">
                ...
                <ChangingPassword v-if="mobileMenuActive.title === 'Смена пароля'"></ChangingPassword>
                <Orders v-if="mobileMenuActive.title === 'Мои заказы'"></Orders>
                <Reviews v-if="mobileMenuActive.title === 'Мои отзывы'"></Reviews>
                <Transactions v-if="mobileMenuActive.title === 'Мои транзакции'"></Transactions>
                <Viewed v-if="mobileMenuActive.title === 'Просмотренные'"></Viewed>
                <Settings v-if="mobileMenuActive.title === 'Настройка профиля'"></Settings>
            </div>
        </div>
    </section>
</template>
