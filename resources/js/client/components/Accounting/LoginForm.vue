    ...
    <form v-on:submit.prevent="login">
        ...
        <div class="dt-input__wrapper">
            ...
            <div class="dt-input__group">
                <input type="text" name="phone" v-model="form.username" placeholder="+7 (000) 000-00-00"
        ...
        <div class="dt-input__wrapper">
            ...
            <div class="dt-input__group">
                <input type="password" name="password" v-model="form.password" class="dt-input" autocomplete="off">
                <div class="dt-input__group-item">
                    <div class="dt-input__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%"
                             viewBox="0 0 48 48" fill="#222425" opacity="0.15">
                            <path
