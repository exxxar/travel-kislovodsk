    ...
    <form v-on:submit.prevent="registration">
        ...
        <div class="dt-check align-items-start mt-2">
            <div class="dt-check__input">
                <input type="checkbox" v-model="form.i_am_guide"/>
        ...
        <div class="dt-check__group mt-2" v-if="form.i_am_guide">
...
export default {
    ...
    watch: {
        'form.i_am_guide': function (oldVal, newVal) {
            this.form.law_status = this.form.i_am_guide ? 1 : 0;
            console.log("law status", this.form.law_status)
        }
    },
    methods: {
        registration() {
