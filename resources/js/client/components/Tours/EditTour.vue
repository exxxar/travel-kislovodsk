<template>
    <div id="add-excursion" class="add-excursion col ">
        <div class="row align-items-center mx-0 mb-4 mb-lg-5">
            <button @click="$emit('hideEditExcursion')"
            ...
            <h1 class="col-12 col-lg-auto bold fs-2 ms-lg-3 mt-5 mt-lg-0 px-0">Редактирование экскурсии</h1>
        </div>
...
export default {
    ...
    methods: {
        ...
        loadTourObjects() {
            return this.$store.dispatch("loadGuideTourObjectsByPage").then(() => {
        ...
        loadTourByTourId() {
            return this.$store.dispatch("loadGuideTourById", this.tourId).then((resp) => {
                this.tour = resp.data
