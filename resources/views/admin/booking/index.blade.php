                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'additional_services'">{{ trans('admin.booking.columns.additional_services') }}</th>
                                        <th is='sortable' :column="'email'">{{ trans('admin.booking.columns.email') }}</th>
                                        <th is='sortable' :column="'fname'">{{ trans('admin.booking.columns.fname') }}</th>
                                        <th is='sortable' :column="'id'">{{ trans('admin.booking.columns.id') }}</th>
                                        <th is='sortable' :column="'payed_at'">{{ trans('admin.booking.columns.payed_at') }}</th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.booking.columns.phone') }}</th>
                                        <th is='sortable' :column="'selected_prices'">{{ trans('admin.booking.columns.selected_prices') }}</th>
                                        <th is='sortable' :column="'sname'">{{ trans('admin.booking.columns.sname') }}</th>
                                        <th is='sortable' :column="'start_at'">{{ trans('admin.booking.columns.start_at') }}</th>
                                        <th is='sortable' :column="'tname'">{{ trans('admin.booking.columns.tname') }}</th>
                                        <th is='sortable' :column="'tour_id'">{{ trans('admin.booking.columns.tour_id') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.additional_services }}</td>
                                        ...
                                        <td>@{{ item.fname }}</td>
                                        <td>@{{ item.id }}</td>
                                        <td>@{{ item.payed_at | datetime }}</td>
                                        <td>@{{ item.phone }}</td>
                                        <td>@{{ item.selected_prices }}</td>
                                        <td>@{{ item.sname }}</td>
