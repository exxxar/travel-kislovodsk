            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/reviews/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.review.actions.create') }}</a>
                    </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'images'">{{ trans('admin.review.columns.images') }}</th>
                                        <th is='sortable' :column="'rating'">{{ trans('admin.review.columns.rating') }}</th>
                                        <th is='sortable' :column="'tour_guide_id'">{{ trans('admin.review.columns.tour_guide_id') }}</th>
                                        <th is='sortable' :column="'tour_id'">{{ trans('admin.review.columns.tour_id') }}</th>
