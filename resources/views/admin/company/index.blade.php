                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'inn'">{{ trans('admin.company.columns.inn') }}</th>
                                        <th is='sortable' :column="'law_address'">{{ trans('admin.company.columns.law_address') }}</th>
                                        <th is='sortable' :column="'ogrn'">{{ trans('admin.company.columns.ogrn') }}</th>
                                        <th is='sortable' :column="'photo'">{{ trans('admin.company.columns.photo') }}</th>
                                        <th is='sortable' :column="'title'">{{ trans('admin.company.columns.title') }}</th>
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="8">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3" @click="bulkDelete('/admin/companies/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
