...
class FillPermissionsForFavorite extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFavorite constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.favorite',
            'admin.favorite.index',
            'admin.favorite.create',
            'admin.favorite.show',
            'admin.favorite.edit',
            'admin.favorite.delete',
            'admin.favorite.bulk-delete',
        ]);
