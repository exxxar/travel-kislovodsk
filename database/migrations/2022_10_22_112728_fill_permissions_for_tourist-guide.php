...
class FillPermissionsForTouristGuide extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTouristGuide constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tourist-guide',
            'admin.tourist-guide.index',
            'admin.tourist-guide.create',
            'admin.tourist-guide.show',
            'admin.tourist-guide.edit',
            'admin.tourist-guide.delete',
            'admin.tourist-guide.bulk-delete',
        ]);
