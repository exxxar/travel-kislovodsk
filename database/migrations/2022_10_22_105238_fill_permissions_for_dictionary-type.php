...
class FillPermissionsForDictionaryType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDictionaryType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.dictionary-type.index',
            'admin.dictionary-type.create',
            'admin.dictionary-type.show',
            'admin.dictionary-type.edit',
            'admin.dictionary-type.delete',
            'admin.dictionary-type.bulk-delete',
        ]);
