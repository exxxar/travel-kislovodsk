...
class FillPermissionsForTouristMember extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTouristMember constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tourist-member',
            'admin.tourist-member.index',
            'admin.tourist-member.create',
            'admin.tourist-member.show',
            'admin.tourist-member.edit',
            'admin.tourist-member.delete',
            'admin.tourist-member.bulk-delete',
        ]);
