...
class FillPermissionsForTouristAgency extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTouristAgency constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tourist-agency',
            'admin.tourist-agency.index',
            'admin.tourist-agency.create',
            'admin.tourist-agency.show',
            'admin.tourist-agency.edit',
            'admin.tourist-agency.delete',
            'admin.tourist-agency.bulk-delete',
        ]);
