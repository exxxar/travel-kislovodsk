...
class FillPermissionsForTouristGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTouristGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tourist-group',
            'admin.tourist-group.index',
            'admin.tourist-group.create',
            'admin.tourist-group.show',
            'admin.tourist-group.edit',
            'admin.tourist-group.delete',
            'admin.tourist-group.bulk-delete',
        ]);
